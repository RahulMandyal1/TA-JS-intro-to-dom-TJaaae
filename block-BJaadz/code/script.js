...
let hrWithClassImage = document.querySelectorAll('.image');
hrWithClassImage.forEach(hr=> hr.style.border ="2px solid purple")

// Hide the box number 17 (last box).
let boxNumber17 =document.querySelector('.seventeen');
boxNumber17.style.display ="none";
...
para3.innerText = "Prepend inserts as first child just before hr element";
box3.prepend(para3);
...
let allBoxesToArray = Array.from(allBoxes);
...
imageElm.src = "https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80";
// Select the box 7 using class seven
let box7 = document.querySelector('.seven');
// Remove all the elements form box seven
box7.innerHTML = "";
// Append the imgElm to the box no 7
box7.append(imageElm)
// Change the width and height of the image to `100%`
imageElm.style.width = '100%';
imageElm.style.height = '100%';

// Select the box 5 using class five
box5;// already selected and stored  in box5
...
firstAnchor.href = "https://altcampus.school";
secondAnchor.href = "https:// google.com";
